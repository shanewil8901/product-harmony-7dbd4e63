...
/**
 * Local fallback for deployments that do not include the optional scheduler
 * package. The methods remain callable manually in those deployments.
 */
const Cron = (..._args: unknown[]): MethodDecorator =>
