...
export class SalesOrder {
  ...
  /** Sales person credited with the order — commission is paid to them. */
  @Index()
  @Column({ name: 'salesperson_id', type: 'varchar', length: 36, nullable: true })
  salesperson_id!: string | null;

  /** Commission is a share of the PROFIT (not the sales value). Default 10%. */
