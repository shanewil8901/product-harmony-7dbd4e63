...
export class CreateSalesOrderDto {
  ...
  @ApiPropertyOptional({ description: 'Sales person credited — defaults to the creating user' })
  @IsOptional()
  @IsUUID()
  salesperson_id?: string;

  @ApiPropertyOptional({ description: 'Commission as a % of the order profit', default: 10 })
  @IsOptional()
  @IsNumber()
  @Min(0)
