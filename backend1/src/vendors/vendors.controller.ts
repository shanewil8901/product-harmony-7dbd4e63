...
import { VENDOR_DOC_TYPES, VendorDocType } from './vendor-document.entity';
...
export class VendorsController {
  ...
  @Post()
  @Roles('admin', 'manager')
  create(@Body() dto: CreateVendorDto, @Req() req: AuthedRequest) {
  ...
  async uploadDoc(
    ...
    @Body('doc_type') doc_type: VendorDocType,
    ...
    if (!doc_type || !VENDOR_DOC_TYPES.includes(doc_type)) {
