        ...
        <table className="w-full text-sm min-w-[1050px]">
          <thead className="bg-paper-warm text-ink">
            <tr className="text-left">
              {["Order", "Customer", "Sales person", "Date", "Status", "Payment", "Total", "Outstanding", "Actions"].map(
                (h, i) => (
                  <th
                    key={h || i}
          ...
          <tbody className="divide-y divide-brown-50">
            {loading && (
              <tr>
                <td colSpan={9} className="px-4 py-8 text-center text-brown-500 whitespace-nowrap">
                  Loading…
                </td>
              </tr>
            )}
            {!loading && !rows.length && (
              <tr>
                <td colSpan={9} className="px-4 py-12 text-center text-brown-500 whitespace-nowrap">
                  No sales orders yet
                </td>
              </tr>
            )}
              ...
              >
                ...
                <td className="px-4 py-3 whitespace-nowrap min-w-[160px]">
                  <div className="text-ink">
                    <UserName value={o.salesperson_id} />
                  </div>
                  <span className="block text-xs text-brown-500">
                    {o.commission_percent}% of profit ·{" "}
                    {formatMoney(o.commission_amount, o.currency_code)}
                  </span>
                </td>
              ...
              expanded === o.id && (
                <tr key={`${o.id}-items`} className="bg-paper-soft">
                  <td colSpan={9} className="px-4 py-4">
                    ...
                    <div className="mt-3 border-t border-brown-100 pt-3 text-xs">
                      <div className="font-medium uppercase tracking-wide text-brown-500">
                        Sales commission
                      </div>
                      <p className="mt-1 text-ink-muted">
                        ...
                        · profit {formatMoney(o.profit_amount, o.currency_code)} ·{" "}
                        ...
                        · payable so far{" "}
                        <span className="font-mono text-ink">
                          {formatMoney(o.commission_earned_amount, o.currency_code)}
                        </span>
                      </p>
                      <p className="mt-0.5 text-brown-500">
                        {SALES_COMMISSION_STATUS_LABEL[o.commission_status]}
                      </p>
                    </div>
