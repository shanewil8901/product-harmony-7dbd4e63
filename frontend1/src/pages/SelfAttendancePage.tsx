  ...
  const submit = async () => {
    ...
    try {
      ...
      if (saved.pending_approval)
        toast('info', 'Re-entry submitted — pending manager approval');
    ...
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      <div className="card p-5 space-y-4">
        ...
        {state?.pending_approval && (
          <div
            role="status"
            className="rounded-xl border border-gold-300 bg-paper-warm p-3 text-sm text-brown-600"
          >
            Your re-entered attendance for {prettyDate(workDate)} is <strong>Pending Approval</strong>
            . The recorded times below stay unchanged until a manager or admin approves it.
          </div>
        )}
